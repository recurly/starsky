...
Rabbit.prototype.__proto__ = EventEmitter.prototype;

/**
 * Mixin `Configurable`.
 */

Configurable(Rabbit.prototype);
...
Object.defineProperty(Rabbit.prototype, 'ready', {
  get: function () {
...
Object.defineProperty(Rabbit.prototype, 'logger', {
  value: bunyan.createLogger({ name: 'rabbit-node' })
});
...
Rabbit.prototype.connect = function (opts) {
...
Rabbit.prototype.send = function (topic, msg, callback) {
...
Rabbit.prototype.queue = function (name) {
...
Rabbit.prototype.onConnectionReady = function () {
...
Rabbit.prototype.onConnection = function () {
  this.logger.debug('connect');
  this.emit('connect');
};
...
Rabbit.prototype.onConnectionClose = function () {
...
Rabbit.prototype.onConnectionError = function (err) {
  this.logger.fatal(err);
  this.emit('error', err);
};

/**
 * Attach the `Rabbit` constructor as a property so
...
Rabbit.prototype.Rabbit = Rabbit;

/**
 * Export a `Rabbit` singleton.
 */

module.exports = exports = new Rabbit();